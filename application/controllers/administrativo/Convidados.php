...
class Convidados extends BaseCrud 
{
    var $modelname = 'user'; /* Nome do model sem o "_model" */
    var $base_url = 'administrativo/convidados';
    var $actions = 'CRUD';
    var $acoes_extras = array(array('url'=>'administrativo/convidados/perfil','title'=>'Ver Perfil','class'=>'btn btn-success'),);
    var $acoes_controller = array(array("url" => "administrativo/convidados/exportar/3", "title" => "Exportar Convidados", "class" => "btn btn-info","icon"=>"glyphicon glyphicon-download-alt"));
    var $titulo = 'Convidados';
    var $tabela = 'name,email,status';
    var $campos_busca = 'email,name,lastname';
    var $joins = array('user_types' => 'user_types.user_type_id=user.user_type_id AND user.user_type_id=3');
    ...
    {
        $where_ativo['user.user_type_id'] = 3;
    }
