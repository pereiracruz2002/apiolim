...
class Chefs extends BaseCrud {

    var $modelname = 'user'; /* Nome do model sem o "_model" */
    var $base_url = 'administrativo/chefs';
    var $actions = 'CRUD';
    var $acoes_extras = array(array('url' => 'administrativo/chefs/perfil', 'title' => 'Ver Perfil', 'class' => 'btn btn-success'),);
    var $acoes_controller = array(array("url" => "administrativo/chefs/exportar/2", "title" => "Exportar Chefs", "class" => "btn btn-info", "icon" => "glyphicon glyphicon-download-alt"));
    var $titulo = 'Chefs';
    var $tabela = 'name,email,status';
    var $campos_busca = 'email,name,lastname';
    var $joins = array('user_types' => 'user_types.user_type_id=user.user_type_id AND user.user_type_id=2');
...
//        exit();
    ...
    public function _filter_pre_listar(&$where, &$where_ativo) {
        $where_ativo['user.user_type_id'] = 2;
    }
