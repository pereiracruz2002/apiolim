...
<div id="main-container">
    ...
    <div class="col-md-12">	
        ...
        ?>
        <?php echo $c->_call_pre_form($model, $data); ?>
        <div class="panel-body">
            <form action="<?php echo site_url($url . $action); ?>" method="post" class="form-horizontal no-margin form-border" enctype="multipart/form-data">             
                <?php $c->_call_filter_pre_form($data); ?>
                <?php echo call_user_func_array(array($model, 'form'), $data) ?>
