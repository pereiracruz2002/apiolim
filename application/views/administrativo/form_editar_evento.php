        ...
        <div class="panel-body">
            ...
            <div class="calendario tabcontent">
                ...
                <div class="form-group">
                    ...
                    <div class="error">Campo Obrigatório</div>
                    <input type="text" name="dateend" id="dateend" class="form-control required" value="<?php echo ((isset($info['end']) && (strtotime($info['end']) >= 0)) ? date("d/m/Y", strtotime($info['end'])) : '') ?>" />
                </div>
                <div class="form-group">
...
<?php endforeach; ?>
            ...
            <div class="preco tabcontent">
                ...
                <div class="row-cupom">
                    <div class="row">
                        <h4 class="alert alert-success">Código de ativação: <strong><?php echo $info['code'] ?></strong></h4>
                        <div class="form-group">
                    ...
                    <div class="row lista-cupom">
                        <?php
                        $cupon_int = 0;
                        foreach ($info['cupons'] as $id => $cupom):
                            ?>
                            <script type="text/javascript">
                                newobjt = {};
                                newobjt.id = "<?php echo $id ?>";
                                newobjt.cupom = "<?php echo $cupom['cupom'] ?>";
                                cupons_saved.push(newobjt);
                            ...
                            <div class='box-cupom' data-id='<?php echo ++$cupon_int ?>'>
                                <span class='desc_cupom'><?php echo $cupom['cupom'] ?></span>
                                <button class='btn btn-remove-cupom' data-id='<?php echo $cupon_int ?>'><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
